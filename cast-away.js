...
},{"./custom-receiver":2,"./event_emitter":3,"./media_controls":4,"./session":5}],2:[function(require,module,exports){
// Generated by CoffeeScript 1.7.1
(function() {
...
(function() {
  ...
  Session = (function(_super) {
    ...
    Session.prototype.tvShow = function(config, callbacks) {
      var mediaInfo, metadata;
      if (config == null) {
        config = {};
      }
    ...
    Session.prototype.movie = function(config, callbacks) {
      var mediaInfo, metadata;
      if (config == null) {
        config = {};
      }
    ...
    Session.prototype.photo = function(config, callbacks) {
      var mediaInfo, metadata;
      if (config == null) {
        config = {};
      }
...
},{"./event_emitter":3,"./media_controls":4}]},{},[1])